...
More specifically, the bra-ket of a vector with itself, $$\braket{\Psi\vert\Psi} =: \|\Psi\|^2 \ge 0$$ is a positive number or zero and its (positive) square-root $$\sqrt{\braket{\Psi\vert\Psi}}=\|\Psi\|=:\Psi$$ called its **_norm_**. We have also introduced some mathematical notations here:
