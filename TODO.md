...
- [x] Deliverable #1 — pilot Resogram end-to-end: equation handles + `verify:` markers + real SymPy/Lean — **closed as decomposed umbrella (children id:96ad/id:d0bf/id:9b2d track the remainder)** <!-- id:01a7 -->
