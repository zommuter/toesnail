...
// Per-renderer macro mirrors live in tests/lib/macros.cjs -- ONE copy, shared with the
// advisory dreamed tier (id:8b1c). The drift guard further down asserts they are
// byte-identical to _includes/custom-head.html and .vscode/settings.json.
